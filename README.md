...
It returns *G_cons*, matrices *Z_s*, *Z_t*, *W_y*, *W_r*, and structure array *data_out*, which containes the time (in seconds) spent constructing *G_cons*, the network's states matrices, and the synaptic weight matrices.
